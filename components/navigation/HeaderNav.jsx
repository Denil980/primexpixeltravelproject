...
export const HeaderNav = () => {
  ...
  return (
    <>
      ...
      >
        ...
        <div className="mx-auto max-w-7xl px-3 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between">
            ...
            {/* Mobile & Tablet Right Corner Hamburger Menu Button */}
            <button
              type="button"
            ...
            >
              {menuOpen ? (
                <XMarkIcon className="h-5 w-5 text-[#fef08a]" />
              ) : (
                <Bars3Icon className="h-6 w-6 text-[#fef08a]" />
              )}
            </button>
          </div>
        </div>
      ...
      {menuOpen && (
        <div className="md:hidden fixed inset-0 z-[100] flex flex-col justify-start pt-20 px-3 sm:px-4 pb-8 overflow-y-auto">
          {/* Backdrop */}
          <div
          ...
          {/* Menu Card */}
          <div className="relative z-10 w-full max-w-sm ml-auto rounded-3xl border border-slate-200/90 bg-white p-5 sm:p-6 shadow-2xl overflow-hidden flex flex-col space-y-4 my-auto sm:my-0">
            {/* Top Gold Bar */}
